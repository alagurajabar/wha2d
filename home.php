    ...
    <div class="content">
      <div class="cards">
        ...
        <div class="card">
          ...
          </div><!-- Displays the humidity and temperature values received from ESP32. *** -->
<h4 class="temperatureColor"><i class="fas fa-thermometer-half"></i> TEMPERATURE</h4>
<p class="temperatureColor"><span class="reading"><span id="ESP32_01_Temp"></span> &

          <!-- *********************************************************************** -->
          
          <p class="statusreadColor"><span>Status Read Sensor  : </span><span id="ESP32_01_Status_Read_DHT11"></span></p>
        </div>
        <!-- ======================================================================================================= -->
      ...
      function Get_Data(id) {
        ...
        xmlhttp.onreadystatechange = function() {
          if (this.readyState == 4 && this.status == 200) {
            ...
            if (myObj.id == "esp32_01") {document.getElementById("ESP32_01_Temp").innerHTML = myObj.temperature;
...
document.getElementById("ESP32_01_AccX").innerHTML = myObj.accelerometer_x;
document.getElementById("ESP32_01_AccY").innerHTML = myObj.accelerometer_y;
document.getElementById("ESP32_01_AccZ").innerHTML = myObj.accelerometer_z;
