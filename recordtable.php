      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          foreach ($pdo->query($sql) as $row) {
            ...
            // Add accelerometer data columns
            echo '<td class="bdr">'. $row['accelerometer_x'] . '</td>';
            echo '<td class="bdr">'. $row['accelerometer_y'] . '</td>';
            echo '<td class="bdr">'. $row['accelerometer_z'] . '</td>';
            // Add GPS data columns
            echo '<td class="bdr">'. $row['latitude'] . '</td>';
            echo '<td class="bdr">'. $row['longitude'] . '</td>';
